...
- `ASTER__APIS__DINGO__HOST` -
  host of the dingo API
  (default: `localhost`)
- `ASTER__APIS__DINGO__PATH` -
  path of the dingo API
  (default: ``)
- `ASTER__APIS__DINGO__PORT` -
  port of the dingo API
  (default: `10101`)
...
- `ASTER__APIS__ICANHAZDADJOKE__PATH` -
  path of the icanhazdadjoke API
  (default: ``)
- `ASTER__APIS__ICANHAZDADJOKE__PORT` -
